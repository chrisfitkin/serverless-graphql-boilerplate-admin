...
export const buildFields = introspectionResults => (fields, depth = 0) =>
  fields.reduce((acc, field) => {
    ...
    const maxDepth = 5;
    if (depth >= maxDepth - 1) return acc;
    depth++;
    ...
    if (linkedType) {
      return {
        ...acc,
        [field.name]: {
          fields: buildFields(introspectionResults)(linkedType.fields, depth)
        }
      };
    }
